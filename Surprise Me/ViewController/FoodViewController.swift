            ...
            if let safeResp = response {
                ...
                if let strIngred1 = safeResp.meals[0].strIngredient1 {
                    if strIngred1 != "" {
                        ...
                        self.strIngred1Lbl.text = "Title: \(strIngred1)"
                    } else {
                ...
                if let strIngred2 = safeResp.meals[0].strIngredient2 {
                    if strIngred2 != "" {
                        ...
                        self.strIngred2Lbl.text = "Title: \(strIngred2)"
                    } else {
                ...
                if let strIngred3 = safeResp.meals[0].strIngredient3 {
                    if strIngred3 != "" {
                        ...
                        self.strIngred3Lbl.text = "Title: \(strIngred3)"
                    } else {
                ...
                if let strIngred4 = safeResp.meals[0].strIngredient4 {
                    if strIngred4 != "" {
                        ...
                        self.strIngred4Lbl.text = "Title: \(strIngred4)"
                    } else {
                ...
                if let strIngred5 = safeResp.meals[0].strIngredient5 {
                    if strIngred5 != "" {
                        ...
                        self.strIngred5Lbl.text = "Title: \(strIngred5)"
                    } else {
                ...
                if let strIngred6 = safeResp.meals[0].strIngredient6 {
                    if strIngred6 != "" {
                        ...
                        self.strIngred6Lbl.text = "Title: \(strIngred6)"
                    } else {
                ...
                if let strIngred7 = safeResp.meals[0].strIngredient7 {
                    if strIngred7 != "" {
                        ...
                        self.strIngred7Lbl.text = "Title: \(strIngred7)"
                    } else {
                ...
                if let strIngred8 = safeResp.meals[0].strIngredient8 {
                    if strIngred8 != "" {
                        ...
                        self.strIngred8Lbl.text = "Title: \(strIngred8)"
                    } else {
                ...
                if let strIngred9 = safeResp.meals[0].strIngredient9 {
                    if strIngred9 != "" {
                        ...
                        self.strIngred9Lbl.text = "Title: \(strIngred9)"
                    } else {
                ...
                if let strIngred10 = safeResp.meals[0].strIngredient10 {
                    if strIngred10 != "" {
                        ...
                        self.strIngred10Lbl.text = "Title: \(strIngred10)"
                    } else {
                ...
                if let strIngred11 = safeResp.meals[0].strIngredient11 {
                    if strIngred11 != "" {
                        ...
                        self.strIngred11Lbl.text = "Title: \(strIngred11)"
                    } else {
                ...
                if let strIngred12 = safeResp.meals[0].strIngredient12 {
                    if strIngred12 != "" {
                        ...
                        self.strIngred12Lbl.text = "Title: \(strIngred12)"
                    } else {
                ...
                if let strIngred13 = safeResp.meals[0].strIngredient13 {
                    if strIngred13 != "" {
                        ...
                        self.strIngred13Lbl.text = "Title: \(strIngred13)"
                    } else {
                ...
                if let strIngred14 = safeResp.meals[0].strIngredient14 {
                    if strIngred14 != "" {
                        ...
                        self.strIngred14Lbl.text = "Title: \(strIngred14)"
                    } else {
                ...
                if let strIngred15 = safeResp.meals[0].strIngredient15 {
                    if strIngred15 != "" {
                        ...
                        self.strIngred15Lbl.text = "Title: \(strIngred15)"
                    } else {
                ...
                if let strIngred16 = safeResp.meals[0].strIngredient16 {
                    if strIngred16 != "" {
                        ...
                        self.strIngred16Lbl.text = "Title: \(strIngred16)"
                    } else {
                ...
                if let strIngred17 = safeResp.meals[0].strIngredient17 {
                    if strIngred17 != "" {
                        ...
                        self.strIngred17Lbl.text = "Title: \(strIngred17)"
                    } else {
                ...
                if let strIngred18 = safeResp.meals[0].strIngredient18 {
                    if strIngred18 != "" {
                        ...
                        self.strIngred18Lbl.text = "Title: \(strIngred18)"
                    } else {
                ...
                if let strIngred19 = safeResp.meals[0].strIngredient19 {
                    if strIngred19 != "" {
                        ...
                        self.strIngred19Lbl.text = "Title: \(strIngred19)"
                    } else {
                ...
                if let strIngred20 = safeResp.meals[0].strIngredient20 {
                    if strIngred20 != "" {
                        ...
                        self.strIngred20Lbl.text = "Title: \(strIngred20)"
                    } else {
